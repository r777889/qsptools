 ...
 * @author pseudo555
 */
public class SelectMultipleFilePanel extends javax.swing.JPanel {

	private static final long serialVersionUID = 4057097313385616205L;
     ...
     * @param testAction
     */
    public SelectMultipleFilePanel(ActionListener nextAction, ActionListener testAction) {
            ...
            public void itemStateChanged(ItemEvent ie) {
                ...
                if(selected.isRequiredAppId()){
                    if(selected.getAppId() == null || selected.getAppId().isEmpty()){
                        String resp = JOptionPane.showInputDialog(SelectMultipleFilePanel.this, "What is your appId for service "+selected.getName(), "App ID required !", JOptionPane.QUESTION_MESSAGE);
        ...
        // from combobox
        selectedFromLg.setModel( new DefaultComboBoxModel(new String[] {RUSSIAN}));
        selectedFromLg.setRenderer(new EnumComoboboxRenderer());
        selectedFromLg.setSelectedItem( RUSSIAN);
        ...
        // to combobox
        selectedToLg.setModel( new QspGenericComboboxModel<>(ELanguage.values()));
        ...
        openBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                JFileChooser fc = TranslatorUtils.getRenpyFileChooser();
                if (fc.showOpenDialog(SelectMultipleFilePanel.this) == JFileChooser.APPROVE_OPTION) {
...
//                    System.out.println(selectedRows[idx]+ " -> " +modelIdx);
        ...
        loadDico.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if( JFileChooser.APPROVE_OPTION == fc.showOpenDialog(SelectMultipleFilePanel.this)){
                    if(!TranslatorUtils.fillDico(model, fc.getSelectedFile())){
                        JOptionPane.showMessageDialog(SelectMultipleFilePanel.this, "Import failed.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
        ...
        saveDico.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JFileChooser fc = TranslatorUtils.getDicoFileChooser();
                if( JFileChooser.APPROVE_OPTION == fc.showSaveDialog(SelectMultipleFilePanel.this)){
                    if(!TranslatorUtils.persistDico(model.getCustomDico(), fc.getSelectedFile())){
                        JOptionPane.showMessageDialog(SelectMultipleFilePanel.this, "export failed.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    private void selectFile(File file){
        if(file == null) {
            ...
            filenameLabel.setText("Please, select a folder");
        } else {
    ...
    private void initComponents() {
        ...
        filenameLabel.setText("Please, select a renpy folder");
        gridBagConstraints = new java.awt.GridBagConstraints();
